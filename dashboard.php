        ...
        <div class="bg-white" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush my-3">
                ...
                <a href="#" class="list-group-item list-group-item-action bg-transparent second-text fw-bold"
                    onclick="resetBookForm()" data-bs-toggle="modal" data-bs-target="#modal-book"><i
...
if (isset($_POST['search'])) {
    ...
    livre.Date_de_publication FROM  livre, Category WHERE category.id = livre.category_id AND livre.Titre LIKE '%$book%'";
...
?>
            ...
            ">
                            ...
                            <div class="modal-body">
                                <div class="" id="">
                                    <input type="text" id="profileId" name="profileId" value="<?=$row['id'];?>"
                                        style="display: none">
                            ...
                            <div class="modal-footer" style="border: none">
                                <button type="button" class="btn btn-primary border rounded-pill"
                                    data-bs-dismiss="modal">
                                    Cancel
                                </button>
                                <button type="submit" id="updateProfile" class="btn btn-success rounded-pill text-white"
                                    name="updateProfile">
                                    Update
                                </button>
                        </form>
        ...
        <div class="modal-dialog">
            ...
            ">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="" id="">
                            <label class="col-form-label text-black">Quantite</label>
                            <input type="text" class="form-control" id="newQuantite" name="newQuantite" />
                        </div>
                        <div class="" id="">
                            <label class="col-form-label text-black">ISBN</label>
                            <input type="text" class="form-control" id="newIsbn" name="newIsbn" />
                        </div>
                        <div class="">
                            <label class="col-form-label text-black">Category</label>
